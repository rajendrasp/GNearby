...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2fconnections_5fenums_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_proto_2fconnections_5fenums_2eproto_2epb_2eh
...
constexpr ConnectionsStrategy ConnectionsStrategy_MIN = static_cast<ConnectionsStrategy>(0);
constexpr ConnectionsStrategy ConnectionsStrategy_MAX = static_cast<ConnectionsStrategy>(5);
constexpr int ConnectionsStrategy_ARRAYSIZE = 5 + 1;
...
const std::string& ConnectionsStrategy_Name(ConnectionsStrategy value);
bool ConnectionsStrategy_Parse(absl::string_view name, ConnectionsStrategy* value);
...
constexpr SessionRole SessionRole_MIN = static_cast<SessionRole>(0);
constexpr SessionRole SessionRole_MAX = static_cast<SessionRole>(2);
constexpr int SessionRole_ARRAYSIZE = 2 + 1;
...
const std::string& SessionRole_Name(SessionRole value);
bool SessionRole_Parse(absl::string_view name, SessionRole* value);
enum Medium : int {
  UNKNOWN_MEDIUM = 0,
  MDNS [[deprecated]] = 1,
  BLUETOOTH = 2,
...
constexpr Medium Medium_MIN = static_cast<Medium>(0);
constexpr Medium Medium_MAX = static_cast<Medium>(11);
constexpr int Medium_ARRAYSIZE = 11 + 1;
...
const std::string& Medium_Name(Medium value);
bool Medium_Parse(absl::string_view name, Medium* value);
...
constexpr ConnectionTechnology ConnectionTechnology_MIN = static_cast<ConnectionTechnology>(0);
constexpr ConnectionTechnology ConnectionTechnology_MAX = static_cast<ConnectionTechnology>(11);
constexpr int ConnectionTechnology_ARRAYSIZE = 11 + 1;
...
const std::string& ConnectionTechnology_Name(ConnectionTechnology value);
bool ConnectionTechnology_Parse(absl::string_view name, ConnectionTechnology* value);
...
constexpr ConnectionBand ConnectionBand_MIN = static_cast<ConnectionBand>(0);
constexpr ConnectionBand ConnectionBand_MAX = static_cast<ConnectionBand>(7);
constexpr int ConnectionBand_ARRAYSIZE = 7 + 1;
...
const std::string& ConnectionBand_Name(ConnectionBand value);
bool ConnectionBand_Parse(absl::string_view name, ConnectionBand* value);
...
constexpr ConnectionRequestResponse ConnectionRequestResponse_MIN = static_cast<ConnectionRequestResponse>(0);
constexpr ConnectionRequestResponse ConnectionRequestResponse_MAX = static_cast<ConnectionRequestResponse>(4);
constexpr int ConnectionRequestResponse_ARRAYSIZE = 4 + 1;
...
const std::string& ConnectionRequestResponse_Name(ConnectionRequestResponse value);
bool ConnectionRequestResponse_Parse(absl::string_view name, ConnectionRequestResponse* value);
...
constexpr ConnectionAttemptResult ConnectionAttemptResult_MIN = static_cast<ConnectionAttemptResult>(0);
constexpr ConnectionAttemptResult ConnectionAttemptResult_MAX = static_cast<ConnectionAttemptResult>(3);
constexpr int ConnectionAttemptResult_ARRAYSIZE = 3 + 1;
...
const std::string& ConnectionAttemptResult_Name(ConnectionAttemptResult value);
bool ConnectionAttemptResult_Parse(absl::string_view name, ConnectionAttemptResult* value);
...
constexpr ConnectionAttemptDirection ConnectionAttemptDirection_MIN = static_cast<ConnectionAttemptDirection>(0);
constexpr ConnectionAttemptDirection ConnectionAttemptDirection_MAX = static_cast<ConnectionAttemptDirection>(2);
constexpr int ConnectionAttemptDirection_ARRAYSIZE = 2 + 1;
...
const std::string& ConnectionAttemptDirection_Name(ConnectionAttemptDirection value);
bool ConnectionAttemptDirection_Parse(absl::string_view name, ConnectionAttemptDirection* value);
...
constexpr ConnectionAttemptType ConnectionAttemptType_MIN = static_cast<ConnectionAttemptType>(0);
constexpr ConnectionAttemptType ConnectionAttemptType_MAX = static_cast<ConnectionAttemptType>(3);
constexpr int ConnectionAttemptType_ARRAYSIZE = 3 + 1;
...
const std::string& ConnectionAttemptType_Name(ConnectionAttemptType value);
bool ConnectionAttemptType_Parse(absl::string_view name, ConnectionAttemptType* value);
...
constexpr DisconnectionReason DisconnectionReason_MIN = static_cast<DisconnectionReason>(0);
constexpr DisconnectionReason DisconnectionReason_MAX = static_cast<DisconnectionReason>(6);
constexpr int DisconnectionReason_ARRAYSIZE = 6 + 1;
...
const std::string& DisconnectionReason_Name(DisconnectionReason value);
bool DisconnectionReason_Parse(absl::string_view name, DisconnectionReason* value);
...
constexpr PayloadType PayloadType_MAX = static_cast<PayloadType>(3);
constexpr int PayloadType_ARRAYSIZE = 3 + 1;
...
const std::string& PayloadType_Name(PayloadType value);
bool PayloadType_Parse(absl::string_view name, PayloadType* value);
...
constexpr PayloadStatus PayloadStatus_MIN = static_cast<PayloadStatus>(0);
constexpr PayloadStatus PayloadStatus_MAX = static_cast<PayloadStatus>(11);
constexpr int PayloadStatus_ARRAYSIZE = 11 + 1;
...
const std::string& PayloadStatus_Name(PayloadStatus value);
bool PayloadStatus_Parse(absl::string_view name, PayloadStatus* value);
enum Bandwidth : int {
  BANDWIDTH_UNKNOWN = 0,
  BANDWIDTH_24_GHZ = 1,
  BANDWIDTH_5_GHZ = 2,
...
constexpr Bandwidth Bandwidth_MIN = static_cast<Bandwidth>(0);
constexpr Bandwidth Bandwidth_MAX = static_cast<Bandwidth>(3);
constexpr int Bandwidth_ARRAYSIZE = 3 + 1;
...
const std::string& Bandwidth_Name(Bandwidth value);
bool Bandwidth_Parse(absl::string_view name, Bandwidth* value);
...
constexpr BandwidthUpgradeResult BandwidthUpgradeResult_MIN = static_cast<BandwidthUpgradeResult>(0);
constexpr BandwidthUpgradeResult BandwidthUpgradeResult_MAX = static_cast<BandwidthUpgradeResult>(19);
constexpr int BandwidthUpgradeResult_ARRAYSIZE = 19 + 1;
...
const std::string& BandwidthUpgradeResult_Name(BandwidthUpgradeResult value);
bool BandwidthUpgradeResult_Parse(absl::string_view name, BandwidthUpgradeResult* value);
...
constexpr BandwidthUpgradeErrorStage BandwidthUpgradeErrorStage_MIN = static_cast<BandwidthUpgradeErrorStage>(0);
constexpr BandwidthUpgradeErrorStage BandwidthUpgradeErrorStage_MAX = static_cast<BandwidthUpgradeErrorStage>(34);
constexpr int BandwidthUpgradeErrorStage_ARRAYSIZE = 34 + 1;
...
const std::string& BandwidthUpgradeErrorStage_Name(BandwidthUpgradeErrorStage value);
bool BandwidthUpgradeErrorStage_Parse(absl::string_view name, BandwidthUpgradeErrorStage* value);
enum LogSource : int {
...
constexpr LogSource LogSource_MAX = static_cast<LogSource>(5);
constexpr int LogSource_ARRAYSIZE = 5 + 1;
...
constexpr PowerLevel PowerLevel_MIN = static_cast<PowerLevel>(-1);
constexpr PowerLevel PowerLevel_MAX = static_cast<PowerLevel>(3);
constexpr int PowerLevel_ARRAYSIZE = 3 + 1;
...
const std::string& PowerLevel_Name(PowerLevel value);
bool PowerLevel_Parse(absl::string_view name, PowerLevel* value);
...
constexpr OperationResultCategory OperationResultCategory_MIN = static_cast<OperationResultCategory>(0);
constexpr OperationResultCategory OperationResultCategory_MAX = static_cast<OperationResultCategory>(9);
constexpr int OperationResultCategory_ARRAYSIZE = 9 + 1;
...
const std::string& OperationResultCategory_Name(OperationResultCategory value);
bool OperationResultCategory_Parse(absl::string_view name, OperationResultCategory* value);
...
constexpr OperationResultDetail OperationResultDetail_MIN = static_cast<OperationResultDetail>(0);
constexpr OperationResultDetail OperationResultDetail_MAX = static_cast<OperationResultDetail>(4566);
constexpr int OperationResultDetail_ARRAYSIZE = 4566 + 1;
const std::string& OperationResultDetail_Name(OperationResultDetail value);
template <typename T>
const std::string& OperationResultDetail_Name(T value) {
  static_assert(std::is_same<T, OperationResultDetail>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to OperationResultDetail_Name().");
  return OperationResultDetail_Name(static_cast<OperationResultDetail>(value));
}
const std::string& OperationResultDetail_Name(OperationResultDetail value);
bool OperationResultDetail_Parse(absl::string_view name, OperationResultDetail* value);
...
template <>
struct is_proto_enum<::location::nearby::proto::connections::OperationResultDetail> : std::true_type {};
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_proto_2fconnections_5fenums_2eproto_2epb_2eh
