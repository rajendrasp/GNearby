    ...
    OnceClosure error_callback)
{
    ...
    adapter_->RegisterAdvertisement(
        ...
        [this, callback](device::BluetoothAdvertisement* advertisement) {
            OnRegisterAdvertisement(callback, advertisement);
        },
        [this, error_callback](device::BluetoothAdvertisement::ErrorCode error_code) {
            OnRegisterAdvertisementError(error_callback, error_code);
        });
}
