...
namespace windows {
    ...
    namespace sharing {
        ...
        connections::Payload ConvertToServicePayload(Payload payload)
        {
            ...
            case PayloadContent::Type::kFile:
            {
                ...
                connections::Payload nc_payload(payload.id, parent_folder, file_name,
                    std::move(input_file));
                return nc_payload;
            }
            case PayloadContent::Type::kBytes:
            {
                ...
                return connections::Payload(payload.id,
